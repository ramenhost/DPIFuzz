...
func main() {
	...
	timeout := flag.Int("timeout", 20, "The amount of time in seconds spent when completing the test. Defaults to 15. When set to 0, the test ends as soon as possible.")
	source := flag.Int64("source", 98269818471122413, "The source for the random number generator.")
