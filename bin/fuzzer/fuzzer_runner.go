...
func main() {
	...
	timeout := flag.Int("timeout", 15, "The amount of time in seconds spent when completing the test. Defaults to 15. When set to 0, the test ends as soon as possible.")
